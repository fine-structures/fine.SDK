...
func init() {
	proto.RegisterType((*CatalogState)(nil), "fine.CatalogState")
}

func init() { proto.RegisterFile("fine/fine.proto", fileDescriptor_5ef11d9c64c217e5) }
