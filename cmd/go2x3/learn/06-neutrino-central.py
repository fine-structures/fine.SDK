...
#### +++ 2023 / ACO
#### Below is an abandoned attempt to equate graph labels before it was well understood that the labels are not unique.
#### Ken Griggs insisted this was the path with his "phoenix theory", but he didn't get this was about connecting mass with time. 
#### It is hereby retained as a memorial to Ken Griggs efforts whereever he may be.
#### I kept trying to tell him there was something way bigger -- something even deeper than combinatorics connecting things together.
#### +++
